...
Read [01-prd.md](./docs/01-prd.md) for the what and why. If you are touching the interface, [06-ux-design.md](./docs/06-ux-design.md) is not optional, see below. Setup is in [10-setup.md](./docs/10-setup.md).

---

## Interface changes

The design has rules, written down in [06-ux-design.md](./docs/06-ux-design.md). The ones that get missed:
...
Smoke checks worth rerunning if you touched search, voting or submissions are listed at the bottom of [10-setup.md](./docs/10-setup.md).
...
Migrations are additive only, see decision 7 in [09-decisions.md](./docs/09-decisions.md#7-database--orm). Do not edit a migration that has already been merged, write a new one.
...
- If a choice in [09-decisions.md](./docs/09-decisions.md) needs revisiting, say so explicitly and propose the update rather than silently diverging from it.

---

## Questions

Open an issue, or check [09-decisions.md](./docs/09-decisions.md) first, the answer to "why is it built this way" is often already there.
